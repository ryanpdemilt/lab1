...
def train(args,local_world_size,rank):
    ...
    for epoch in range(0, args.epochs):
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            with amp.scale_loss(xentropy_loss, optimizer) as scaled_loss:
...
def ddp_main(args,local_world_size,local_rank):
    ...
    dist.init_process_group(backend="NCCL", rank = int(env_dict["RANK"]),world_size=int(env_dict["WORLD_SIZE"]))
    print(
